...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cms_basecontent', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['cms.BaseContent'])),
            ('portal_type', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ...
            ('pagination', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ...
        db.send_create_signal('cms', ['BaseContent'])

        # Adding unique constraint on 'BaseContent', fields ['parent', 'slug']
        db.create_unique('cms_basecontent', ['parent_id', 'slug'])

        # Adding model 'Folder'
        db.create_table('cms_folder', (
            ('basecontent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.BaseContent'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('cms', ['Folder'])

        # Adding model 'MultiPage'
        db.create_table('cms_multipage', (
            ('basecontent_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.BaseContent'], unique=True, primary_key=True)),
            ('show_toc', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('cms', ['MultiPage'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'BaseContent', fields ['parent', 'slug']
        db.delete_unique('cms_basecontent', ['parent_id', 'slug'])

        # Deleting model 'BaseContent'
        db.delete_table('cms_basecontent')

        # Deleting model 'Folder'
        db.delete_table('cms_folder')

        # Deleting model 'MultiPage'
        db.delete_table('cms_multipage')
    ...
    models = {
        ...
        'cms.basecontent': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'unique_together': "(('parent', 'slug'),)", 'object_name': 'BaseContent'},
            'content_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'efective': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'pagination': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['cms.BaseContent']"}),
            'portal_type': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        'cms.file': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'object_name': 'File', '_ormbases': ['cms.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.BaseContent']", 'unique': 'True', 'primary_key': 'True'}),
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
        'cms.folder': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'object_name': 'Folder', '_ormbases': ['cms.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.BaseContent']", 'unique': 'True', 'primary_key': 'True'})
        },
        'cms.image': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'object_name': 'Image', '_ormbases': ['cms.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.BaseContent']", 'unique': 'True', 'primary_key': 'True'}),
            'image': ('socialapps.core.fields.thumbs.ImageWithThumbsField', [], {'max_length': '100'})
        },
        'cms.multipage': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'object_name': 'MultiPage', '_ormbases': ['cms.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.BaseContent']", 'unique': 'True', 'primary_key': 'True'}),
            'show_toc': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'cms.page': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'object_name': 'Page', '_ormbases': ['cms.BaseContent']},
            'basecontent_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.BaseContent']", 'unique': 'True', 'primary_key': 'True'}),
