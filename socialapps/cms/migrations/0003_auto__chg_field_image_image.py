...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cms_image', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Image.image'
        db.alter_column('cms_image', 'image', self.gf('socialapps.core.fields.thumbs.ImageWithThumbsField')(max_length=100))
