...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cms_file', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'File.file'
        db.alter_column('cms_file', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
